...
<figure class="imported-figure" style="--media-width: 1216px"><img src="/assets/squarespace/c9383c7fcecf-IMG_0223.webp" alt="Four magic triominoes" loading="lazy" class="imported-media" /><figcaption>Four magic triominoes</figcaption></figure>
...
<figure class="imported-figure" style="--media-width: 1514px"><img src="/assets/squarespace/33ef7e4a1d9c-IMG_0227.webp" alt="Placing two triominoes so that squares of opposite colors are on top of each other annihilates those squares." loading="lazy" class="imported-media" /><figcaption>Placing two triominoes so that squares of opposite colors are on top of each other annihilates those squares.</figcaption></figure>
...
<img src="/assets/squarespace/3e9246d170ba-IMG_0226.webp" alt="Two red-and-blue triominoes aligned so that their red squares stack to height 2." loading="lazy" class="imported-media" />
